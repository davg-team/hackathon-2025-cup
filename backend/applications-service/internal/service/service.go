...
type ApplicationStorage interface {
	...
	Applications(ctx context.Context, applicationStatus string, teamID string, eventID string, dateFilter string) ([]models.ApplicationModel, error)
...
func (s *ApplicationService) Applications(ctx context.Context, applicationStatus string, teamID string, eventID string, userID string, dateFilter string) ([]responses.GetApplicationResponse, error) {
	...
	applications, err := s.storage.Applications(ctx, applicationStatus, teamID, eventID, dateFilter)
	if err != nil {
