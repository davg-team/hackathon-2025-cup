...
type ApplicationService interface {
	...
	Applications(ctx context.Context, applicationStatus string, teamID string, eventID string, userID string, dateFilter string, fspID string) ([]responses.GetApplicationResponse, error)
