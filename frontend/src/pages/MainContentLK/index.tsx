...
//                       minRows={5}
//                       maxRows={10}
//                       value={presenters.description || "Описание отсутствует"}
//                     />
//                     <Button
//                       onClick={async () => {
//                         const url =
//                           "/api/organizations/" + regionId + "/description";
//                         const response = await fetch(url, {
//                           method: "PUT",
//                           headers: {
...
//                       <Text variant="body-3">{presenters.description}</Text>
//                     )}
//                   </>
//                 )}
//               </>
...
//                 <Col s="8" style={{ paddingRight: "1rem" }}>
//                   <EventsMainContent />
//                 </Col>
...
//                   </Card>
//                 </Flex>
//                 <Text variant="display-1">Контакты</Text>
//                 <Card
//                   type="container"
//                   view="outlined"
//                   style={{
